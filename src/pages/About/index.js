                    ...
                    <div>
                        <div className=" row ">
                            <div className=" col-md-4 ">
                                <h2 className=" works_title "><b>About</b></h2>
                                <h4 className=" works_small_title " >WE'RE MORE
                                    THAN A DIGITAL AGENCY
                                </h4>
                            </div>
                            <div className=" col-md-8 " >
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore corrupti temporibus
                                    fuga earum asperiores, alias excepturi sit. Impedit, fugit laudantium.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=" row ">
                        <div className=" col-md-4 ">
                            ...
                            <p>Bring to the table win-win survival strategies to ensure proactive domination. At the end
                                of the day, going forward will have multiple touchpoints for offshoring.</p>
                        </div>
                        <div className=" col-md-4 ">
                            <h3 className=" works_sub ">Our philosophy
                            </h3>
